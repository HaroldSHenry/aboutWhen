...
( function ( $ ) {
  $.fn.aboutWhen = function ( settings ) {
    return this.each( function ( settings ) {
      ...
      lbl = _bldL( bId + "yL", text.Nm[0], pos );
      ...
      pos += wdth[0] + 2;
      lbl = _bldL( bId + "mL", text.Nm[1], pos );
      this.appendChild( lbl );
      ...
      pos += wdth[1] + 2;
      lbl = _bldL( bId + "dL", text.Nm[2], pos );
      this.appendChild( lbl );
      ...
      pos += wdth[2] + 2;
      lbl = _bldL( bId + "wL", text.Nm[3], pos );
      this.appendChild( lbl );
    } );
  };
} )( jQuery );
